import herobg from "../../Assets/Image/hero-bg-1.webp";

import Looptext from "./Looptext";

export default function Hero() {
  return (
    <div className='w-full h-dvh bg-[#efeeec] relative flex justify-center items-center'>
      ...
      <h1 className='relative z-10 text-center -translate-y-16 text-white leading-[33px] text-4xl sm:text-5xl sm:leading-[43px] '>
        <span className='neue-bold'>Forging</span> websites{" "}
        <br className='lg:hidden' />
        that <br className='hidden lg:block' /> level up your{" "}
        <br className='lg:hidden' />
