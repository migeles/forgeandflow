...
const Navmenu = forwardRef((props, ref) => {
  return (
    ...
    <div ref={ref} className='absolute opacity-0 bg-black/30 backdrop-blur-[6px] top-0 left-0 w-full h-screen z-10 px-9 pt-28 pb-6 flex-col flex justify-between'>
